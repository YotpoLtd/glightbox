...
function initHlsVideo(url, video, defaultOptions, videoPlayers, callback, slide, videoID) {
    ...
    hls.on(Hls.Events.MANIFEST_PARSED, function () {
        defaultOptions = configureQualityOptions(hls, defaultOptions);
        hls.on(Hls.Events.LEVEL_SWITCHED, (event, data) => changeUIQualityLabel(event, data, hls));
...
function changeUIQualityLabel(event, data, hls) {
...
function configureQualityOptions(hls, defaultOptions) {

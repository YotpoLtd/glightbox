(function (global, factory) {
  ...
  function slideVideo(slide, data, index, callback) {
    ...
    injectAssets(this.settings.plyr.js, 'Plyr', function () {
      ...
      var placeholder;
      if (provider === 'kaltura') {
        var playerContainerId = 'kaltura_player_573480599';
        customPlaceholder = createHTML("<div id=\"".concat(playerContainerId, "\" class=\"gvideo-local\" style=\"background:#000; max-width: ").concat(data.width, "; height: ").concat(data.height || '640px', "\" data-plyr-provider=\"").concat(provider, "\" data-plyr-embed-id=\"").concat(url, "\"></div>"));
      }
      placeholder = customPlaceholder ? customPlaceholder : createHTML("<div id=\"".concat(videoID, "\" data-plyr-provider=\"").concat(provider, "\" data-plyr-embed-id=\"").concat(url, "\"></div>"));
      ...
      value: function build() {
        ...
        if (this.settings.closeOnOutsideClick) {
          this.events['outClose'] = addEvent('click', {
            onElement: modal,
            withCallback: function withCallback(e, target) {
              if (!_this8.preventOutsideClick && !hasClass(document.body, 'glightbox-mobile') && !closest(e.target, '.ginner-container')) {
